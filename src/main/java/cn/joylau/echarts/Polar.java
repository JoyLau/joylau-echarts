...
import cn.joylau.echarts.axis.AxisLabel;
import cn.joylau.echarts.axis.AxisLine;
import cn.joylau.echarts.axis.SplitArea;
import cn.joylau.echarts.axis.SplitLine;
import cn.joylau.echarts.code.PolarType;
...
public class Polar extends AbstractData<Polar> implements Component {
     ...
     *
     * @see cn.joylau.echarts.axis.AxisLine
     */
    private AxisLine axisLine;
    /**
     * 坐标轴文本标签，详见axis.axisLabel
     *
     * @see cn.joylau.echarts.axis.AxisLabel
     */
    private AxisLabel axisLabel;
    /**
     * 分隔区域，默认不显示，属性show控制显示与否，属性areaStyle（详见areaStyle）控制区域样式
     *
     * @see cn.joylau.echarts.axis.SplitArea
     */
