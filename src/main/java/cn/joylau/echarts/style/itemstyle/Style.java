...
package cn.joylau.echarts.style.itemstyle;


import cn.joylau.echarts.Label;
import cn.joylau.echarts.LabelLine;
import cn.joylau.echarts.code.Position;
import cn.joylau.echarts.style.*;
...
public abstract class Style<T> implements Serializable {
     ...
     * 饼图标签视觉引导线，默认显示
     *
     * @see cn.joylau.echarts.LabelLine
     */
     ...
     * 和弦图 - 弦样式
     *
     * @see cn.joylau.echarts.style.ChordStyle
     */
    private ChordStyle chordStyle;
    /**
     * 力导向图 - 弦样式
     *
     * @see cn.joylau.echarts.style.NodeStyle
     */
    private NodeStyle nodeStyle;
    /**
     * 力导向图 - 弦样式
     *
     * @see cn.joylau.echarts.style.LinkStyle
     */
