...
import cn.joylau.echarts.Chart;
import cn.joylau.echarts.Tooltip;
import cn.joylau.echarts.code.*;
...
public abstract class Series<T> extends AbstractData<T> implements Chart {
     ...
     * 标注
     *
     * @see cn.joylau.echarts.series.MarkPoint
     */
     ...
     * 标线
     *
     * @see cn.joylau.echarts.series.MarkLine
     */
